...
%   - (\)ere(cipe)
% - Custom Commands:
%   - \chapterrec              - usual chapter meant to have a fore-text
%   - \chaptertoc              - chapter with table of contents
%   - \recipe                  - custom section command
...
%   - IT (ingredients/timeline in 2 column) [<col ratio>]
%   - twocols
...
%---------------------------------------------------------------------------}}}1
\erecipe{Blueberry Muffins}{\CIBaking[39]} % {{{1
\index{Blueberry Muffins|see{\CIBaking[39]}}
\index{muffins!Blueberry Muffins|see{\CIBaking[39]}}
%---------------------------------------------------------------------------}}}1
